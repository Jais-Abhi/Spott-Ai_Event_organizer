...
export default function Home() {
  return (
    <section>
      <div>
        {/* top */}
        <div className=" h-[120vh] md:h-[90vh] flex max-md:flex-col" >
          {/* left */}
          <div className=" h-[80%] w-full md:w-1/2 text-wrap flex flex-col md:h-full justify-center items-center px-2 md:items-start md:px-10 lg:px-30" >
